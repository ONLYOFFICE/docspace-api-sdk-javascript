...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocspaceApiTypescript.CustomerConfigDto();
  });
  ...
  describe('CustomerConfigDto', function() {
    it('should create an instance of CustomerConfigDto', function() {
      ...
      //var instance = new DocspaceApiTypescript.CustomerConfigDto();
      //expect(instance).to.be.a(DocspaceApiTypescript.CustomerConfigDto);
    });
