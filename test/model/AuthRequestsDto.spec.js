...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocspaceApiTypescript.AuthRequestsDto();
  });
  ...
  describe('AuthRequestsDto', function() {
    it('should create an instance of AuthRequestsDto', function() {
      ...
      //var instance = new DocspaceApiTypescript.AuthRequestsDto();
      //expect(instance).to.be.a(DocspaceApiTypescript.AuthRequestsDto);
    });
