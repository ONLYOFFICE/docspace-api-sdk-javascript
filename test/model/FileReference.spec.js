...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocspaceApiTypescript.FileReference();
  });
  ...
  describe('FileReference', function() {
    it('should create an instance of FileReference', function() {
      ...
      //var instance = new DocspaceApiTypescript.FileReference();
      //expect(instance).to.be.a(DocspaceApiTypescript.FileReference);
    });
