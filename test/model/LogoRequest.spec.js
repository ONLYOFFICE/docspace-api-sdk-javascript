...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocspaceApiTypescript.LogoRequest();
  });
  ...
  describe('LogoRequest', function() {
    it('should create an instance of LogoRequest', function() {
      ...
      //var instance = new DocspaceApiTypescript.LogoRequest();
      //expect(instance).to.be.a(DocspaceApiTypescript.LogoRequest);
    });
