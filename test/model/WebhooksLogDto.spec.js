...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocspaceApiTypescript.WebhooksLogDto();
  });
  ...
  describe('WebhooksLogDto', function() {
    it('should create an instance of WebhooksLogDto', function() {
      ...
      //var instance = new DocspaceApiTypescript.WebhooksLogDto();
      //expect(instance).to.be.a(DocspaceApiTypescript.WebhooksLogDto);
    });
