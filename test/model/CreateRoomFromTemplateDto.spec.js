...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocspaceApiTypescript.CreateRoomFromTemplateDto();
  });
  ...
  describe('CreateRoomFromTemplateDto', function() {
    it('should create an instance of CreateRoomFromTemplateDto', function() {
      ...
      //var instance = new DocspaceApiTypescript.CreateRoomFromTemplateDto();
      //expect(instance).to.be.a(DocspaceApiTypescript.CreateRoomFromTemplateDto);
    });
