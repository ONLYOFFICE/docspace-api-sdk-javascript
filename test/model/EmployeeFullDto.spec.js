...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocspaceApiTypescript.EmployeeFullDto();
  });
  ...
  describe('EmployeeFullDto', function() {
    it('should create an instance of EmployeeFullDto', function() {
      ...
      //var instance = new DocspaceApiTypescript.EmployeeFullDto();
      //expect(instance).to.be.a(DocspaceApiTypescript.EmployeeFullDto);
    });
