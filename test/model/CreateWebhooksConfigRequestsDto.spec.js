...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocspaceApiTypescript.CreateWebhooksConfigRequestsDto();
  });
  ...
  describe('CreateWebhooksConfigRequestsDto', function() {
    it('should create an instance of CreateWebhooksConfigRequestsDto', function() {
      ...
      //var instance = new DocspaceApiTypescript.CreateWebhooksConfigRequestsDto();
      //expect(instance).to.be.a(DocspaceApiTypescript.CreateWebhooksConfigRequestsDto);
    });
