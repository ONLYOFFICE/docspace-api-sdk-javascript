...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocspaceApiTypescript.FileDtoInteger();
  });
  ...
  describe('FileDtoInteger', function() {
    it('should create an instance of FileDtoInteger', function() {
      ...
      //var instance = new DocspaceApiTypescript.FileDtoInteger();
      //expect(instance).to.be.a(DocspaceApiTypescript.FileDtoInteger);
    });
