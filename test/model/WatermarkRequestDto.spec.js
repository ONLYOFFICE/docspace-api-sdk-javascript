...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocspaceApiTypescript.WatermarkRequestDto();
  });
  ...
  describe('WatermarkRequestDto', function() {
    it('should create an instance of WatermarkRequestDto', function() {
      ...
      //var instance = new DocspaceApiTypescript.WatermarkRequestDto();
      //expect(instance).to.be.a(DocspaceApiTypescript.WatermarkRequestDto);
    });
