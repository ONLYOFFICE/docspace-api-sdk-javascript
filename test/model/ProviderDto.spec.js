...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocspaceApiTypescript.ProviderDto();
  });
  ...
  describe('ProviderDto', function() {
    it('should create an instance of ProviderDto', function() {
      ...
      //var instance = new DocspaceApiTypescript.ProviderDto();
      //expect(instance).to.be.a(DocspaceApiTypescript.ProviderDto);
    });
