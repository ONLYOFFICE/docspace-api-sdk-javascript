...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocspaceApiTypescript.FolderDtoInteger();
  });
  ...
  describe('FolderDtoInteger', function() {
    it('should create an instance of FolderDtoInteger', function() {
      ...
      //var instance = new DocspaceApiTypescript.FolderDtoInteger();
      //expect(instance).to.be.a(DocspaceApiTypescript.FolderDtoInteger);
    });
