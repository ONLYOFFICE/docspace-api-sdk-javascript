...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocspaceApiJavascript.FolderDtoInteger();
  });
  ...
  describe('FolderDtoInteger', function() {
    it('should create an instance of FolderDtoInteger', function() {
      // uncomment below and update the code to test FolderDtoInteger
      //var instance = new DocspaceApiJavascript.FolderDtoInteger();
      //expect(instance).to.be.a(DocspaceApiJavascript.FolderDtoInteger);
    });
