...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocspaceApiTypescript.DownloadRequestDto();
  });
  ...
  describe('DownloadRequestDto', function() {
    it('should create an instance of DownloadRequestDto', function() {
      ...
      //var instance = new DocspaceApiTypescript.DownloadRequestDto();
      //expect(instance).to.be.a(DocspaceApiTypescript.DownloadRequestDto);
    });
