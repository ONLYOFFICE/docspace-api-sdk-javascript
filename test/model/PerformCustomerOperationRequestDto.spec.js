...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.PerformCustomerOperationRequestDto();
  });
  ...
  describe('PerformCustomerOperationRequestDto', function() {
    it('should create an instance of PerformCustomerOperationRequestDto', function() {
      ...
      //var instance = new Api.PerformCustomerOperationRequestDto();
      //expect(instance).to.be.a(Api.PerformCustomerOperationRequestDto);
    });
