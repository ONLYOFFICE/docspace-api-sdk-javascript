...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocspaceApiTypescript.EditHistoryUrl();
  });
  ...
  describe('EditHistoryUrl', function() {
    it('should create an instance of EditHistoryUrl', function() {
      ...
      //var instance = new DocspaceApiTypescript.EditHistoryUrl();
      //expect(instance).to.be.a(DocspaceApiTypescript.EditHistoryUrl);
    });
