...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocspaceApiTypescript.CreateRoomRequestDto();
  });
  ...
  describe('CreateRoomRequestDto', function() {
    it('should create an instance of CreateRoomRequestDto', function() {
      ...
      //var instance = new DocspaceApiTypescript.CreateRoomRequestDto();
      //expect(instance).to.be.a(DocspaceApiTypescript.CreateRoomRequestDto);
    });
