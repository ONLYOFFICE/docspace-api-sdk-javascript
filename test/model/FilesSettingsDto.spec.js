...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocspaceApiTypescript.FilesSettingsDto();
  });
  ...
  describe('FilesSettingsDto', function() {
    it('should create an instance of FilesSettingsDto', function() {
      ...
      //var instance = new DocspaceApiTypescript.FilesSettingsDto();
      //expect(instance).to.be.a(DocspaceApiTypescript.FilesSettingsDto);
    });
