...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocspaceApiTypescript.ApiKeyResponseDto();
  });
  ...
  describe('ApiKeyResponseDto', function() {
    it('should create an instance of ApiKeyResponseDto', function() {
      ...
      //var instance = new DocspaceApiTypescript.ApiKeyResponseDto();
      //expect(instance).to.be.a(DocspaceApiTypescript.ApiKeyResponseDto);
    });
