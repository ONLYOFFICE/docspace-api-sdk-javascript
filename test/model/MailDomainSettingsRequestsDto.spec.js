...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocspaceApiTypescript.MailDomainSettingsRequestsDto();
  });
  ...
  describe('MailDomainSettingsRequestsDto', function() {
    it('should create an instance of MailDomainSettingsRequestsDto', function() {
      ...
      //var instance = new DocspaceApiTypescript.MailDomainSettingsRequestsDto();
      //expect(instance).to.be.a(DocspaceApiTypescript.MailDomainSettingsRequestsDto);
    });
