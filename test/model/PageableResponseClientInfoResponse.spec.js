...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.PageableResponseClientInfoResponse();
  });
  ...
  describe('PageableResponseClientInfoResponse', function() {
    it('should create an instance of PageableResponseClientInfoResponse', function() {
      ...
      //var instance = new Api.PageableResponseClientInfoResponse();
      //expect(instance).to.be.a(Api.PageableResponseClientInfoResponse);
    });
