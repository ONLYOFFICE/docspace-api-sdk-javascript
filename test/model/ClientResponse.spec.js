...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocspaceApiTypescript.ClientResponse();
  });
  ...
  describe('ClientResponse', function() {
    it('should create an instance of ClientResponse', function() {
      ...
      //var instance = new DocspaceApiTypescript.ClientResponse();
      //expect(instance).to.be.a(DocspaceApiTypescript.ClientResponse);
    });
