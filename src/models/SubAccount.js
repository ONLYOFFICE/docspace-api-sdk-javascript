...
class SubAccount {
     ...
     * @alias module:models/SubAccount
     */
    constructor() { 
     ...
     * @param {module:models/SubAccount} obj Optional instance to populate.
     * @return {module:models/SubAccount} The populated <code>SubAccount</code> instance.
     */
 ...
 */
SubAccount.prototype['currency'] = undefined;

/**
 * The amount of the sub-account.
 * @member {Number} amount
 */
SubAccount.prototype['amount'] = undefined;
