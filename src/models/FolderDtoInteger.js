...
/**
 * The FolderDtoInteger model module.
 * @module models/FolderDtoInteger
 * @version 3.2.0
 */
class FolderDtoInteger {
    /**
     * Constructs a new <code>FolderDtoInteger</code>.
     * The folder parameters.
     * @alias module:models/FolderDtoInteger
     */
    constructor() { 
        
        FolderDtoInteger.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FolderDtoInteger</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:models/FolderDtoInteger} obj Optional instance to populate.
     * @return {module:models/FolderDtoInteger} The populated <code>FolderDtoInteger</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FolderDtoInteger();
    ...
    /**
     * Validates the JSON data with respect to <code>FolderDtoInteger</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FolderDtoInteger</code>.
     */
...
export default FolderDtoInteger;
