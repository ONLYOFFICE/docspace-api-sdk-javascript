# DocspaceApiTypescript.SecuritySMTPSettingsApi
...
let apiInstance = new DocspaceApiTypescript.SecuritySMTPSettingsApi();
...
let apiInstance = new DocspaceApiTypescript.SecuritySMTPSettingsApi();
let opts = {
  'smtpSettingsDto': new DocspaceApiTypescript.SmtpSettingsDto() // SmtpSettingsDto | 
};
