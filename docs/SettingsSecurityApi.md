# DocspaceApiJavascript.SettingsSecurityApi
...
let apiInstance = new DocspaceApiJavascript.SettingsSecurityApi();
...
let apiInstance = new DocspaceApiJavascript.SettingsSecurityApi();
let opts = {
  'webItemsSecurityRequestsDto': new DocspaceApiJavascript.WebItemsSecurityRequestsDto() // WebItemsSecurityRequestsDto | 
};
...
let apiInstance = new DocspaceApiJavascript.SettingsSecurityApi();
let opts = {
  'securityRequestsDto': new DocspaceApiJavascript.SecurityRequestsDto() // SecurityRequestsDto | 
};
...
let apiInstance = new DocspaceApiJavascript.SettingsSecurityApi();
let opts = {
  'webItemSecurityRequestsDto': new DocspaceApiJavascript.WebItemSecurityRequestsDto() // WebItemSecurityRequestsDto | 
};
...
let apiInstance = new DocspaceApiJavascript.SettingsSecurityApi();
let opts = {
  'passwordSettingsRequestsDto': new DocspaceApiJavascript.PasswordSettingsRequestsDto() // PasswordSettingsRequestsDto | 
};
