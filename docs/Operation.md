# DocspaceApiTypescript.Operation
...
**quantity** | **Number** | Quantity of the service used. | [optional] 
**currency** | **String** | The three-character ISO 4217 currency symbol of the operation. | [optional] 
**credit** | **Number** | Credit amount of the operation. | [optional] 
**withdrawal** | **Number** | Withdrawal amount of the operation. | [optional] 
