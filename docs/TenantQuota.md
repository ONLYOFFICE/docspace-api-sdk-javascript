...
**price** | **Number** | The tenant price. | [optional] 
...
**maxFileSize** | **Number** | The tenant maximum file size. | [optional] 
**maxTotalSize** | **Number** | The tenant maximum total size. | [optional] 
**countUser** | **Number** | The number of portal users. | [optional] 
**countRoomAdmin** | **Number** | The number of portal room administrators. | [optional] 
**usersInRoom** | **Number** | The number of room users. | [optional] 
**countRoom** | **Number** | The number of rooms. | [optional] 
**nonProfit** | **Boolean** | Specifies if the tenant quota is nonprofit or not. | [optional] 
...
**docsEdition** | **Boolean** | Specifies if ONLYOFFICE Docs is included in the tenant quota or not. | [optional] 
...
**autoBackupRestore** | **Boolean** | Specifies if the automatic backup option is enabled or not. | [optional] 
**oauth** | **Boolean** | Specifies if Oauth is available or not. | [optional] 
**contentSearch** | **Boolean** | Specifies if the content search is available or not. | [optional] 
