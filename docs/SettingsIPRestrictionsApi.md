# DocspaceApiTypescript.SettingsIPRestrictionsApi
...
let apiInstance = new DocspaceApiTypescript.SettingsIPRestrictionsApi();
...
let apiInstance = new DocspaceApiTypescript.SettingsIPRestrictionsApi();
let opts = {
  'ipRestrictionsDto': new DocspaceApiTypescript.IpRestrictionsDto() // IpRestrictionsDto | 
};
