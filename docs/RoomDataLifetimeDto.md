...
------------ | ------------- | ------------- | -------------
**deletePermanently** | **Boolean** | Specifies whether to permanently delete the room data or not. | [optional] 
**period** | [**RoomDataLifetimePeriod**](RoomDataLifetimePeriod.md) |  | [optional] 
**value** | **Number** | Specifies the time period value of the room data lifetime. | [optional] 
