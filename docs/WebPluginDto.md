# DocspaceApiTypescript.WebPluginDto
...
**createOn** | **Date** | The date and time when the web plugin was created. | [optional] 
**enabled** | **Boolean** | Specifies if the web plugin is enabled or not. | [optional] 
**system** | **Boolean** | Specifies if the web plugin is system or not. | [optional] 
