# DocspaceApiTypescript.DocServiceUrlDto
...
**docServiceSslVerification** | **Boolean** | Specifies if the document service SSL verification is enabled. | [optional] 
**isDefault** | **Boolean** | Specifies if the document service is default. | 
