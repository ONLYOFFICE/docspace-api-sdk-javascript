...
**folderId** | **Number** | The folder ID where the file is located. | [optional] 
**version** | **Number** | The file version. | [optional] 
**versionGroup** | **Number** | The version group of the file. | [optional] 
**contentLength** | **String** | The content length of the file. | [optional] 
**pureContentLength** | **Number** | The pure content length of the file. | [optional] 
...
**inProcessFolderId** | **Number** | The InProcess folder ID of the file. | [optional] 
...
**availableExternalRights** | **{String: Boolean}** | The available external rights of the file. | [optional] 
