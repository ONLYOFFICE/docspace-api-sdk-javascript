# DocspaceApiJavascript.SettingsLoginSettingsApi
...
let apiInstance = new DocspaceApiJavascript.SettingsLoginSettingsApi();
...
let apiInstance = new DocspaceApiJavascript.SettingsLoginSettingsApi();
let opts = {
  'loginSettingsRequestDto': new DocspaceApiJavascript.LoginSettingsRequestDto() // LoginSettingsRequestDto | 
};
