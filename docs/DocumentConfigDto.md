# DocspaceApiTypescript.DocumentConfigDto
...
**isLinkedForMe** | **Boolean** | Specifies if the documnet is linked for current user. | [optional] 
...
**isForm** | **Boolean** | Indicates whether this is a form. | [optional] 
