# DocspaceApiJavascript.FolderDtoInteger
...
**id** | **Number** | The file entry ID. | [optional] 
**rootFolderId** | **Number** | The root folder ID of the file entry. | [optional] 
**originId** | **Number** | The origin ID of the file entry. | [optional] 
**originRoomId** | **Number** | The origin room ID of the file entry. | [optional] 
...
**parentId** | **Number** | The parent folder ID of the folder. | [optional] 
