# DocspaceApiTypescript.FillingFormResultDtoInteger

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**formNumber** | **Number** | The filling form number. | [optional] 
...
**roomId** | **Number** | The room ID where filling the form. | [optional] 
