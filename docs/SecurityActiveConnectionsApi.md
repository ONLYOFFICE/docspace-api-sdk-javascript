# DocspaceApiJavascript.SecurityActiveConnectionsApi
...
let apiInstance = new DocspaceApiJavascript.SecurityActiveConnectionsApi();
...
------------- | ------------- | ------------- | -------------
 **loginEventId** | **Number**| The ID of the specific login event. | 
