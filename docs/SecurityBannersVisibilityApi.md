# DocspaceApiJavascript.SecurityBannersVisibilityApi
...
let apiInstance = new DocspaceApiJavascript.SecurityBannersVisibilityApi();
let opts = {
  'tenantBannerSettingsDto': new DocspaceApiJavascript.TenantBannerSettingsDto() // TenantBannerSettingsDto | 
};
