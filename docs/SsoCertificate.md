...
------------ | ------------- | ------------- | -------------
**selfSigned** | **Boolean** | Specifies if a certificate is self-signed or not. | [optional] 
...
**startDate** | **Date** | The certificate start date. | [optional] 
**expiredDate** | **Date** | The certificate expiration date. | [optional] 
