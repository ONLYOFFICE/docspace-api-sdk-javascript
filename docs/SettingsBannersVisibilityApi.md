# DocspaceApiJavascript.SettingsBannersVisibilityApi
...
let apiInstance = new DocspaceApiJavascript.SettingsBannersVisibilityApi();
apiInstance.getTenantBannerSettings((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
