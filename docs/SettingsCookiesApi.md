# DocspaceApiJavascript.SettingsCookiesApi
...
let apiInstance = new DocspaceApiJavascript.SettingsCookiesApi();
apiInstance.getCookieSettings((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> StringWrapper updateCookieSettings(opts)
...
let apiInstance = new DocspaceApiJavascript.SettingsCookiesApi();
let opts = {
  'cookieSettingsRequestsDto': new DocspaceApiJavascript.CookieSettingsRequestsDto() // CookieSettingsRequestsDto | 
};
apiInstance.updateCookieSettings(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
